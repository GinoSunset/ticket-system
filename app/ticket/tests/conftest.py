...
def text_dm_ver_2():
    return """
Здравствуйте, ЛАЛАЛЕНД 

На Вас назначен сервисный запрос под номером 8001123123
Информация по сервисному запросу:
Дата регистрации: 19.04.1991 12:39:45 
Тема: Пищат кассы 
Описание: После скачка напряжения,  пищат с разницей в 1 - 2 минуты.
Фото входной зоны и фото с замером прилагаю

Телефон:123456789
Ф.И.О.: Иванов Иван Иванович
Должность: Директор магазина
Магазин/Департамент: ЛУ 2
Регион: Москва 1

Для выполнения сервисного запроса перейдите по ссылке.

Вы можете связаться с заказчиком по адресу <a href="mailto:favicon@email.com">favicon@email.com</a>
...
На Вас назначен сервисный запрос под номером 11111111
Информация по сервисному запросу:
Дата регистрации: 29.04.2023 10:53:07 
Тема: ОА ТРИКОТАЖ 2-й этаж. 
Описание: Доброе утро.\r\n\r\nКассы работают частично.\r\n\r\nНе все реагируют на защиту\r\n\r\nИмя/IP адрес ПК: 1.1.1.1
Телефон:79999999999
Ф.ИО.: Иванов Иван Иванович
Должность: Заместитель директора магазина
Магазин/Департамент: ТП 2-й этаж 2222
Завод: 2222
Регион: Урал

Для выполнения сервисного запроса перейдите по ссылке.

Вы можете связаться с заказчиком по адресу user@email.com
